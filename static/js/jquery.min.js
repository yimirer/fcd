/*! jQuery v1.7.1.png jquery.com | jquery.org/license */
(function (a, b) {
    function cy(a) {
    ...
    function l(a, c, d) {
        if (d === b && a.nodeType === 1) {
            var e = "data-" + c.replace(k, "-$1.png").toLowerCase();
            d = a.getAttribute(e);
            if (typeof d == "string") {
                try {
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function () {
        ...
        e.fn = e.prototype = {
            ...
            }, selector: "", jquery: "1.png.7.1.png", length: 0, size: function () {
                return this.length
            }, toArray: function () {
    ...
    var z = /^(?:textarea|input|select)$/i, A = /^([^\.]*)?(?:\.(.+))?$/, B = /\bhover(\.\S+)?\b/, C = /^key/,
        ...
        F = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, G = function (a) {
            ...
            return f.event.special.hover ? a : a.replace(B, "mouseenter$1.png mouseleave$1.png")
        };
    f.event = {
            ...
            preFilter: {
                CLASS: function (a, b, c, d, e, f) {
                    ...
                    if (a[1] === "nth") {
                        ...
                        var b = /(-?)(\d*)(?:n([+\-]?\d*))?/.exec(a[2] === "even" && "2n" || a[2] === "odd" && "2n+1.png" || !/\D/.test(a[2]) && "0n+" + a[2] || a[2]);
    ...
    f.fn.css = function (a, c) {
        ...
        var c, d, e;
        b = b.replace(bs, "-$1.png").toLowerCase(), (d = a.ownerDocument.defaultView) && (e = d.getComputedStyle(a, null)) && (c = e.getPropertyValue(b), c === "" && !f.contains(a.ownerDocument.documentElement, a) && (c = f.style(a, b)));
        return c
